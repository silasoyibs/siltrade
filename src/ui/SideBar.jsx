...
function SideBar({ isExpanded, showMobileSideBar }) {
  return (
    <div
      className={`${isExpanded ? "w-60" : "w-20"} ${showMobileSideBar ? "block" : "hidden md:block"} dark:bg-dark-shade overflow-hidden border-r-1 border-[rgba(0,0,0,0.1)] bg-white shadow-sm transition-all`}
    >
